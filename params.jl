...
model_params = (n=n_targets,B_0=starting_population,t_span=treatment_length,A=initial_antibiotic_level,
D_0=maximum_kill_rate,r_T=replication_threshold,k_f=binding_rate,k_r=unbinding_rate,
W=molecular_weight,V=intracellular_volume,C=carrying_capacity,k_T=killing_threshold,n_A=n_A,f=hypergeom_density_mat,
d_x = d_x, r_x=r_x
)
